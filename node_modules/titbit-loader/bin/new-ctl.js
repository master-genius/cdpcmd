 ...
 * @property {helper} helper - 指向helper模块，提供了一些助手函数，具体参考wiki。
 * 
...
for (let c of clist) {
  ...
  try {
    fs.writeFileSync(cpath, makeController(modname), {encoding: 'utf8'})
  } catch (err) {
    console.error(err)
  }
